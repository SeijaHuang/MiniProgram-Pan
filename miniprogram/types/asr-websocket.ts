/**
 * ASR WebSocket Types
 * Types for ASR (Automatic Speech Recognition) text synchronization
 */

import { EWSMessageType, type IWSMessage } from './websocket-common';
 ...
 * Received by other participants in the room
 */
